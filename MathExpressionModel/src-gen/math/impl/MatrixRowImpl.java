 ...
 * </p>
 * <ul>
 *   <li>{@link math.impl.MatrixRowImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MatrixRowImpl extends MinimalEObjectImpl.Container implements MatrixRow {
	...
	protected EClass eStaticClass() {
		return MathExpressionModelPackage.Literals.MATRIX_ROW;
	}
	...
	public EList<Expression> getElements() {
		if (elements == null) {
			elements = new EObjectResolvingEList<Expression>(Expression.class, this,
					MathExpressionModelPackage.MATRIX_ROW__ELEMENTS);
		}
		return elements;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case MathExpressionModelPackage.MATRIX_ROW__ELEMENTS:
			return getElements();
		}
